		    ...
		    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
		      ...
		      <tbody>
		        <tr>
		          ...
		          <td></td>
		          <td>
		          	<a href="../../controller/c_konfirmasi.php?page=konf_krd&nama=<?= $data->nama; ?>" class="btn btn-outline-primary btn-sm" data-toggle="tooltip" data-placement="left" title="Konfirmasi Nilai"><i class="fa fa-refresh"></i> Konfirmasi Nilai</a>
