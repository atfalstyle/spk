<ol class="breadcrumb">
	...
	<li class="breadcrumb-item active">Tambah Data Kriteria 4</li>
</ol>

<div class="card mb-3">
	<div class="card-header"><i class="fa fa-user"></i> Tambah Data Kriteria 4</div>
	<div class="card-body">
		<form action="<?= base_url(); ?>core/Route.php?route=insert_adm_crit_4" method="POST">
			<div class="row">
				<div class="col-md-6">
	...
	<div class="card-footer small text-muted">Tambah Data Kriteria 4</div>
</div>
