...
?>
<div class="card mb-3">
	<div class="card-header"><i class="fa fa-user"></i> Data Penilaian Supervisor</div>
	<div class="card-body">
		<div class="col-md-12">
			<a href="?kontent=penilaian_sv&aksi=tmb" class="btn btn-outline-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Tambah Data"><i class="fa fa-plus"></i> Tambah Data</a>
			<hr>
		</div>
