<ol class="breadcrumb">
	<li class="breadcrumb-item"><a href="#">Data Penilaian Koordinator</a></li>
	<li class="breadcrumb-item active">Edit Data Penilaian Koordinator</li>
</ol>

<div class="card mb-3">
	<div class="card-header"><i class="fa fa-user"></i> Edit Data Penilaian Koordinator</div>
	<div class="card-body">
		<form action="../../controller/c_penilaian.php?page=nilai_edit_a_krd" method="POST">
			<div class="row">
				<div class="col-md-6">
		          <div class="form-group">
		            <label for="nm_k">Pilih Karyawan</label>
		            <input type="hidden" name="id" value="<?= $tampil->id_nilai; ?>">
