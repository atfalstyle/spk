...
?>
<div class="card mb-3">
	<div class="card-header"><i class="fa fa-user"></i> Data Penilaian Koordinator</div>
	<div class="card-body">
		<div class="col-md-12">
			<a href="?kontent=penilaian_krd&aksi=tmb" class="btn btn-outline-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Tambah Data"><i class="fa fa-plus"></i> Tambah Data</a>
			<hr>
		</div>
              ...
              <td></td>
			        <td>
			        	<a href="" class="btn btn-outline-success btn-sm" data-toggle="tooltip" data-placement="top" title="Edit Data"><i class="fa fa-edit"></i></a>
			          	<a onclick="return confirm('Yakin Ingin Hapus Data..??')" href="../../controller/c_penilaian.php?page=nilai_del_a_krd&id=<?= $data->id_nilai; ?>" class="btn btn-outline-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Hapus Data"><i class="fa fa-trash-o"></i></a>
			        </td>
		        </tr>
		      </tbody>
		    </table>
